...
export const Card = ({ className, children }) => {
  return (
    <div
      className={cn(
        "relative z-20 h-full w-full overflow-hidden rounded-2xl border border-transparent bg-purple-100 p-4 group-hover:border-purple-600 dark:border-white/[0.2]",
        className,
      )}
    >
